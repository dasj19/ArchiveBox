...
from abbx.archivebox.base_binary import BaseBinary, BaseBinProvider
...
class InstalledBinary(ABIDModel, ModelWithHealthStats):
    ...
    def clean(self, *args, **kwargs) -> None:
        ...
        if not self.binprovider:
            all_known_binproviders = list(abbx.archivebox.reads.get_BINPROVIDERS().values())
    ...
    def BINPROVIDER(self) -> BaseBinProvider:
        for binprovider in abbx.archivebox.reads.get_BINPROVIDERS().values():
